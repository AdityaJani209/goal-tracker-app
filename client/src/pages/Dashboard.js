  ...
  return (
    <div className="space-y-6">
        ...
        <div className="card p-6">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-warning-100 text-warning-600">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{stats?.inProgress || 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-danger-100 text-danger-600">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">{stats?.overdue || 0}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {stats && (
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Goal Completion Rate</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Goals */}
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Recent Goals</h3>
          ...
          {recentGoals.length > 0 ? (
            <div className="space-y-4">
              {recentGoals.map((goal) => (                <div key={goal._id} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-700">
                  <div className="flex items-start justify-between">
                    ...
                    </div>                    <div className="ml-4 text-right">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating your first goal.</p>
              <div className="mt-4">
        ...
        {/* Quick Actions */}
        <div className="card p-6">          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Quick Actions</h3>
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">Create New Goal</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">View Active Goals</span>
            </Link>            <Link
              to="/analytics"
              className="flex items-center p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
